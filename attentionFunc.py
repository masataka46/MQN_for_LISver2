...
class attentionFunction(function.Function):
    '''
    ...
    def forward(self, inputs):
        ...
        e1_tile = cupy.tile(e1_cube, (1, time_span, 1)).astype(dtype=e1.dtype, copy=False)
    ...
    def backward(self, inputs, grad_outputs):
        ...
        gy_tile = cupy.tile(gy_cube, (1, 1, len(e1[0]))).astype(dtype=gy.dtype, copy=False)
        ...
        e1_tile = cupy.tile(e1_cube, (1, time_span, 1)).astype(dtype=gy.dtype, copy=False)
        #print 'L7 e1_tile.shape=',
        #print e1_tile.shape
...
def attentionFunc(e1, e2, W, V1=None, V2=None, b=None):
    ...
    if any(flags):
        ...
        return attentionFunction()(e1, e2, W)
    else:
        return attentionFunction()(e1, e2, W, V1, V2, b)
